...
public class Video_Fragment_Fav extends Fragment {
    ...
    @BindView(R.id.exo_video_fav)
    SimpleExoPlayerView mPlayerView;
    @BindView(R.id.tv_desc_fav)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.video_fragment_fav, container, false);
