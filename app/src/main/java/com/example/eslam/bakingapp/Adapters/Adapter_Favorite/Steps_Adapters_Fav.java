...
public class Steps_Adapters_Fav extends RecyclerView.Adapter<Steps_Adapters_Fav.ItemViewHolder> {
    private final StepsAdapterOnClick stepsAdapterOnClick;
    private List<Step> mStepsList;

    public Steps_Adapters_Fav(List<Step> mStepsList, StepsAdapterOnClick stepsAdapterOnClick) {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.steps_item_fav, parent, false);
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        @BindView(R.id.tv_short_desc_fav)
        TextView tv_desc;
